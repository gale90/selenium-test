...
public class SeleniumTest {
    ...
    public void verifyCreateRequestForm() {
        Assert.assertEquals(Selenium.newRequestForm(1), "Моите барања");
        Assert.assertEquals(Selenium.newRequestForm(2), "Моите барања");
        Assert.assertEquals(Selenium.newRequestForm(3), "Моите барања");
    }
