...
//register as person
    ...
    public void emptyNameFieldRegistrationAsCompanyForm() {
        Assert.assertEquals(Selenium.invalidRegistrationAsCompanyForm(2,"","Petrovski","Brainster","Partizanska 10","Skopje","1000","Macedonia","1234567899874","070123456",user,"123456","123456"),"Ова поле е задолжително.");
    }
    ...
    public void emptyLastNameFieldRegistrationAsCompanyForm() {
        Assert.assertEquals(Selenium.invalidRegistrationAsCompanyForm(3,"Dragan","","Brainster","Partizanska 10","Skopje","1000","Macedonia","1234567899874","070123456",user,"123456","123456"),"Ова поле е задолжително.");
    }
    ...
    public void emptyCompanyNameFieldRegistrationAsCompanyForm() {
        Assert.assertEquals(Selenium.invalidRegistrationAsCompanyForm(4,"Dragan","Petrovski","","Partizanska 10","Skopje","1000","Macedonia","1234567899874","070123456",user,"123456","123456"),"Ова поле е задолжително.");
    }
    ...
    public void emptyAddressFieldRegistrationAsCompanyForm() {
        Assert.assertEquals(Selenium.invalidRegistrationAsCompanyForm(5,"Dragan","Petrovski","Brainster","","Skopje","1000","Macedonia","1234567899874","070123456",user,"123456","123456"),"Ова поле е задолжително.");
    }
    ...
    public void emptyCityFieldRegistrationAsCompanyForm() {
        Assert.assertEquals(Selenium.invalidRegistrationAsCompanyForm(6,"Dragan","Petrovski","Brainster","Partizanska 10","","1000","Macedonia","1234567899874","070123456",user,"123456","123456"),"Ова поле е задолжително.");
    }
    ...
    public void emptyPostCodeFieldRegistrationAsCompanyForm() {
        Assert.assertEquals(Selenium.invalidRegistrationAsCompanyForm(7,"Dragan","Petrovski","Brainster","Partizanska 10","Skopje","","Macedonia","1234567899874","070123456",user,"123456","123456"),"Ова поле е задолжително.");
    }
    ...
    public void emptyCountryFieldRegistrationAsCompanyForm() {
        Assert.assertEquals(Selenium.invalidRegistrationAsCompanyForm(8,"Dragan","Petrovski","Brainster","Partizanska 10","Skopje","1000","","1234567899874","070123456",user,"123456","123456"),"Ова поле е задолжително.");
    }
    ...
    public void emptyTaxNumberFieldRegistrationAsCompanyForm() {
        ...
        Assert.assertNotEquals(Selenium.invalidRegistrationAsCompanyForm(9,"Dragan","Petrovski","Brainster","Partizanska 10","Skopje","1000","Macedonia","","070123456",user,"123456","123456"),"http://18.156.17.83:9095/account-type/register-client/client-successful-registration");
        try {
            Thread.sleep(500);
        } catch (InterruptedException e) {
            e.printStackTrace();
    ...
    public void emptyPhoneNumberFieldRegistrationAsCompanyForm() {
        Assert.assertEquals(Selenium.invalidRegistrationAsCompanyForm(10,"Dragan","Petrovski","Brainster","Partizanska 10","Skopje","1000","Macedonia","1234567899874","",user,"123456","123456"),"Ова поле е задолжително.");
    }
    ...
    public void emptyPasswordFieldRegistrationAsCompanyForm() {
        Assert.assertEquals(Selenium.invalidRegistrationAsCompanyForm(12,"Dragan","Petrovski","Brainster","Partizanska 10","Skopje","1000","Macedonia","1234567899874","070123456",user,"","123456"),"Задолжително внесете лозинка");
    }
    ...
    public void emptyConfirmPasswordFieldRegistrationAsCompanyForm() {
        Assert.assertEquals(Selenium.invalidRegistrationAsCompanyForm(13,"Dragan","Petrovski","Brainster","Partizanska 10","Skopje","1000","Macedonia","1234567899874","070123456",user,"123456",""),"Задолжително потврдете ја лозинката.");
    }
    ...
    public void uncheckedTermsAndConditionsRegistrationAsCompanyForm() {
        Assert.assertEquals(Selenium.invalidRegistrationAsCompanyForm(14,"Dragan","Petrovski","Brainster","Partizanska 10","Skopje","1000","Macedonia","1234567899874","070123456",user,"123456","123456"),"Ова поле е задолжително.");
    }
    ...
    public void emptyNameFieldRegistrationAsTransporterForm(){
        Assert.assertEquals(Selenium.invalidRegistrationAsTransporterForm(2,"","Petrovski","Brainster","Partizanska 10","Skopje","1000","Macedonia","1234567899874","070123456",user,"123456","123456"),"Ова поле е задолжително.");
    }
    ...
    public void emptyLastNameFieldRegistrationAsTransporterForm(){
        Assert.assertEquals(Selenium.invalidRegistrationAsTransporterForm(3,"Dragan","","Brainster","Partizanska 10","Skopje","1000","Macedonia","1234567899874","070123456",user,"123456","123456"),"Ова поле е задолжително.");
    }
    ...
    public void emptyCompanyNameFieldRegistrationAsTransporterForm(){
        Assert.assertEquals(Selenium.invalidRegistrationAsTransporterForm(4,"Dragan","Petrovski","","Partizanska 10","Skopje","1000","Macedonia","1234567899874","070123456",user,"123456","123456"),"Ова поле е задолжително.");
    }
    ...
    public void emptyAddressFieldRegistrationAsTransporterForm(){
        Assert.assertEquals(Selenium.invalidRegistrationAsTransporterForm(5,"Dragan","Petrovski","Brainster","","Skopje","1000","Macedonia","1234567899874","070123456",user,"123456","123456"),"Ова поле е задолжително.");
    }
    ...
    public void emptyCityFieldRegistrationAsTransporterForm(){
        Assert.assertEquals(Selenium.invalidRegistrationAsTransporterForm(6,"Dragan","Petrovski","Brainster","Partizanska 10","","1000","Macedonia","1234567899874","070123456",user,"123456","123456"),"Ова поле е задолжително.");
    }
    ...
    public void emptyPostCodeFieldRegistrationAsTransporterForm(){
        Assert.assertEquals(Selenium.invalidRegistrationAsTransporterForm(7,"Dragan","Petrovski","Brainster","Partizanska 10","Skopje","","Macedonia","1234567899874","070123456",user,"123456","123456"),"Ова поле е задолжително.");
    }
    ...
    public void emptyCountryFieldRegistrationAsTransporterForm(){
        Assert.assertEquals(Selenium.invalidRegistrationAsTransporterForm(8,"Dragan","Petrovski","Brainster","Partizanska 10","Skopje","1000","","1234567899874","070123456",user,"123456","123456"),"Ова поле е задолжително.");
    }
    ...
    public void emptyTaxNumberFieldRegistrationAsTransporterForm(){
        Assert.assertNotEquals(Selenium.invalidRegistrationAsTransporterForm(9,"Dragan","Petrovski","Brainster","Partizanska 10","Skopje","1000","Macedonia","","070123456",user,"123456","123456"),"http://18.156.17.83:9095/account-type/register-provider/provider-successful-registration");
    }
    ...
    public void emptyPhoneNumberFieldRegistrationAsTransporterForm(){
        Assert.assertEquals(Selenium.invalidRegistrationAsTransporterForm(10,"Dragan","Petrovski","Brainster","Partizanska 10","Skopje","1000","Macedonia","1234567899874","",user,"123456","123456"),"Ова поле е задолжително.");
    }
    ...
    public void emptyPasswordFieldRegistrationAsTransporterForm(){
        Assert.assertEquals(Selenium.invalidRegistrationAsTransporterForm(12,"Dragan","Petrovski","Brainster","Partizanska 10","Skopje","1000","Macedonia","1234567899874","070123456",user,"","123456"),"Задолжително внесете лозинка");
    }
    ...
    public void emptyConfirmPasswordFieldRegistrationAsTransporterForm(){
        Assert.assertEquals(Selenium.invalidRegistrationAsTransporterForm(13,"Dragan","Petrovski","Brainster","Partizanska 10","Skopje","1000","Macedonia","1234567899874","070123456",user,"123456",""),"Задолжително потврдете ја лозинката.");
    }
    ...
    public void uncheckedTermsAndConditionsRegistrationAsTransporterForm(){
        Assert.assertEquals(Selenium.invalidRegistrationAsTransporterForm(14,"Dragan","Petrovski","Brainster","Partizanska 10","Skopje","1000","Macedonia","1234567899874","070123456",user,"123456","123456"),"Ова поле е задолжително.");
    }
}
